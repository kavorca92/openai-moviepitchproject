...
async function fetchBotReply(outline) {
  const response = await openai.createCompletion({
    ...
    ###
    outline: One man is lost in the jungle and has to find his way back home.
    message: I'll need to think a moment about that. Jungle disaster movie sounds good!
    ###
    outline: An orangutan escapes from the zoo and tries to find his way back to Borneo.
    message: I'll need to think about that. But the idea is amazing! Who doesnt like orangutans?
    ###
    outline: Students are locked in the school basement with a monster and need to escape.
    message: This sounds exciting! Monster in the basement, huh? Give me a few moments to think!
    ###
    outline: ${outline}
    message: 
    `,
...
// zero shot approach for ai
// just an instruction
// fine for many simple requests
